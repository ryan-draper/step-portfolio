...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeeWithAllDayIgnored() {
    // Have each person have different events. We should see three options because each person has
    // split the restricted times and we ignore the optional attendee's day-long event.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void optionalAttendeeAlsoConsidered() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times into 3 and we eliminate one of them to accommodate the optional attendee. 
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void optionalAttendeeMakingShorterTimeSlot() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting. Ignore the optional attendee's slot as it makes the time slot shorter than requested.
    //
    // Events  : |--A--|-B-| |----A----|
    // Day     : |---------------------|
    // Options :       |-----|
  ...
  public void onlyOptionalAttendeesWithNoGaps() {
    ...
    // the attendees' events collectively conflict with the entire day.
    //
    // Events  : |------A-------|-------B------|
    // Day     : |-----------------------------|
    // Options : 
